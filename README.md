...
| **Map** | Interactive world map viewer (Leaflet.js) — clickable rooms with popups showing exits, region info, and file paths; room search; click-to-navigate exit links. Falls back to static PNG if JSON data is unavailable |
